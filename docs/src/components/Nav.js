...
export const Nav = () => (
  <>
    <div className="text-leafy-800 sticky z-50 top-0 bg-white bg-opacity-80 backdrop-blur-sm backdrop-saturate-200 backdrop-filter">
      <div className="mx-auto px-4 py-2 max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center">
          <div className="flex items-center pt-4 h-16 md:pt-0">
            <Link href="/" as="/">
              <a className="flex items-center justify-center">
                ...
                <span className="text-sunny-600 ml-2 mt-2 text-xl font-bold">
                  Developer Docs
                </span>
              </a>
            </Link>
          ...
          <div className="flex flex-grow items-center justify-between w-3/4 h-16 space-x-4 md:justify-end md:w-auto md:space-x-8">
            <div className="flex text-sm space-x-4 md:text-base md:space-x-8">
              <Link href="/overview">
                <a className="bg-sunny-500 px-6 py-4 font-medium leading-6">
                  Get Started
                </a>
              </Link>
              <button onClick={() => $crisp.push(["do", "chat:open"])}>
                <a className="px-6 py-4 text-white font-medium leading-6 bg-black">
                  Need Support?
                </a>
              </button>
            </div>
