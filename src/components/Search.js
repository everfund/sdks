...
export const Search = () => {
  ...
  return (
    <div>
      <button
        type="button"
        className="bg-white group form-input hover:text-gray-600 hover:border-gray-300 transition duration-150 ease-in-out pointer flex items-center text-left w-full  z-20 text-gray-500 rounded-lg text-sm align-middle"
        onClick={onOpen}
      >
        <svg
          width="1em"
